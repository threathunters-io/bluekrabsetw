...
namespace ManagedExamples
{
    public static class UserTrace007_StackTrace
    {
        public static void Start()
        {
            ...
            provider.TraceFlags |= TraceFlags.IncludeUserSid;
            provider.TraceFlags |= TraceFlags.IncludeProcessStartKey;
            provider.TraceFlags |= TraceFlags.SourceContainerTrackingEventKey;
            provider.TraceFlags |= TraceFlags.IncludeProcessEventKey;
            provider.TraceFlags |= TraceFlags.IncludeTerminalSessionId;
